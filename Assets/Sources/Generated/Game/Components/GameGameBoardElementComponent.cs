...
public partial class GameContext {
    ...
    public GameEntity gameBoardElementEntity { get { return GetGroup(GameMatcher.GameBoardElement).GetSingleEntity(); } }

    public bool isGameBoardElement {
        get { return gameBoardElementEntity != null; }
        set {
            var entity = gameBoardElementEntity;
            if (value != (entity != null)) {
                if (value) {
                    CreateEntity().isGameBoardElement = true;
                } else {
                    entity.Destroy();
                }
            }
